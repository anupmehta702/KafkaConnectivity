...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6567878546815295897L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"avro.vo\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"totalAmount\",\"type\":\"int\"},{\"name\":\"nbOfItems\",\"type\":\"int\"}]}");
  ...
  @Deprecated public int totalAmount;
   ...
   */
  public Order(java.lang.CharSequence userId, java.lang.Integer totalAmount, java.lang.Integer nbOfItems) {
    this.userId = userId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: totalAmount = (java.lang.Integer)value$; break;
   ...
   */
  public static avro.vo.Order.Builder newBuilder() {
    return new avro.vo.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static avro.vo.Order.Builder newBuilder(avro.vo.Order.Builder other) {
    return new avro.vo.Order.Builder(other);
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static avro.vo.Order.Builder newBuilder(avro.vo.Order other) {
    return new avro.vo.Order.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.vo.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.vo.Order other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.Order.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.Order.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.Order.Builder setTotalAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.Order.Builder clearTotalAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.Order.Builder setNbOfItems(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.Order.Builder clearNbOfItems() {
    ...
    public Order build() {
      try {
        ...
        record.totalAmount = fieldSetFlags()[1] ? this.totalAmount : (java.lang.Integer) defaultValue(fields()[1]);
