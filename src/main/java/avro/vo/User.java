...
public class User extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 952165193909312741L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"avro.vo\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"username\",\"type\":\"string\"},{\"name\":\"dateOfBirth\",\"type\":\"int\",\"logicalType\":\"date\"}]}");
   ...
   */
  public static avro.vo.User.Builder newBuilder() {
    return new avro.vo.User.Builder();
  }
   ...
   * @return A new User RecordBuilder
   */
  public static avro.vo.User.Builder newBuilder(avro.vo.User.Builder other) {
    return new avro.vo.User.Builder(other);
  }
   ...
   * @return A new User RecordBuilder
   */
  public static avro.vo.User.Builder newBuilder(avro.vo.User other) {
    return new avro.vo.User.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.vo.User.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.vo.User other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.User.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.User.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.User.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.User.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.User.Builder setDateOfBirth(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.vo.User.Builder clearDateOfBirth() {
