...
public class Task implements Runnable {
    ...
    private void printRecordDetails(ConsumerRecord record,String action){
        System.out.println(String.format(action+" record Topic:%s Partition:%s Offset:%s Key:%s Value:%s"
    ...
    public void run() {
        ...
        for (ConsumerRecord<String, String> record : records) {
            ...
            printRecordDetails(record,"processing");
